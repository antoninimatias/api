...
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'root','root','$2a$10$RWjgys2ii1LXVZ44St6nKeZsPEWaLD0poUbwo40sMkToF9POWJBYG','antonini@oi.com.br', 'LEITURA_CLIENTE,ESCRITA_CLIENTE,LEITURA_USUARIO,ESCRITA_USUARIO');
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'João','joao','$2a$10$PlfihKXsv6pDYBMhmpCaMOs/4sTT.WR2.vpOdqyDBlY0J/Ph5r2iW','joao@oi.com.br', 'LEITURA_CLIENTE,ESCRITA_CLIENTE');